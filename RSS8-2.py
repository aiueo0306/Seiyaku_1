...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.eapharma.co.jp/medical/news"
GAKKAI = "EAファーマ（医療機関）"

SELECTOR_TITLE = "div.hcp-paragraph li"
title_selector = "dd.notes"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "div.hcp-paragraph li"  # typo修正済み
date_selector = "dt.date"
date_index = 0
year_unit = "年"
month_unit = "月"
day_unit = "日"
