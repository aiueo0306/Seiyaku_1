...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.alfresa-pharma.co.jp/medical/"
GAKKAI = "アルフレッサファーマ(医療機関)"

SELECTOR_TITLE = "div.simplebar-content:nth-of-type(1) dl"
title_selector = "dd"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "div.simplebar-content:nth-of-type(1) dl"  # typo修正済み
date_selector = "span"
date_index = 0
year_unit = "/"
month_unit = "/"
