...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.meiji-seika-pharma.co.jp/me-pharma/medical/news/index.html"
GAKKAI = "Meijiファルマ"

SELECTOR_TITLE = "ul#jsCsvNews li"
title_selector = "a"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul#jsCsvNews li"  # typo修正済み
date_selector = "p"
date_index = 0
year_unit = "."
month_unit = "."
    ...
    try:
        ...
        if POPUP_MODE and POPUP_BUTTONS:
            for i, label in enumerate(POPUP_BUTTONS, start=1):
                page.locator("a[onclick*='薬剤師']").click()
