...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://a-connect.abbvie.co.jp/?diseaseArea=all"
GAKKAI = "アッヴィ(医療関係)"

SELECTOR_TITLE = "ul.dashboard-news li"
title_selector = "a"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul.dashboard-news li"  # typo修正済み
date_selector = "p.dashboard-news__date"
date_index = 0
year_unit = "年"
month_unit = "月"
day_unit = "日"
...
POPUP_BUTTONS = ["同意し継続する","薬剤師の方"]  # 必要に応じて編集
